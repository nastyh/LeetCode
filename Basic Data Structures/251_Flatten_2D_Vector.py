class Vector2D:
    def __init__(self, v):  # O(N + V), N -- num of integers, V -- num of inner lists. Space is O(N)
        self.v = v
        self.l = []
        self._helper(v)
        self.pointer = -1
    ...
    def _helper(self, v):  # just save everything in a list and traverse it 
...
class Vector2D:  # with two pointers. One tracks inner lists, another tracks a position inside an inner list  
    ...
    def advance_to_next(self):  # O(V/N) , V number of inner lists, N number of elements
